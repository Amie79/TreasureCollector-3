...
skeleton=createSprite(965,85);
 ...
 skeleton3=createSprite(1000,540);
...
function draw() {
  ...
  if(frameCount%150==0){
    skeleton1.x=Math.round(random(180,600))
  }

  if(frameCount%150==0){
    skeleton2.x=Math.round(random(180,600))
  }

  if(frameCount%150==0){
    skeleton2.x=Math.round(random(940,450))
  }
  pirate.velocityX=0;
  pirate.velocityY=0;
  createEdgeSprites();
